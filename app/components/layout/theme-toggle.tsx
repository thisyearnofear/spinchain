      ...
      `}>
        ...
        `}>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="t-icon-swap w-3.5 h-3.5" data-state={isDark ? 'b' : 'a'}>
              {/* Moon icon */}
              <svg
                className="t-icon w-3.5 h-3.5 text-white"
                data-icon="b"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
...
export function ThemeToggleCompact() {
  ...
  return (
    <button
      ...
      aria-label={isDark ? 'Switch to light mode' : 'Switch to dark mode'}
    >
      <div className="t-icon-swap relative w-5 h-5" data-state={isDark ? 'b' : 'a'}>
        {/* Sun */}
        <svg
