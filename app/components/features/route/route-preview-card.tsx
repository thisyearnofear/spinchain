...
export function RoutePreviewCard({
  ...
  const elevationProfile = useMemo(() => {
    ...
    return routeData.storyBeats.map((_: StoryBeat, index: number) => {
        ...
        {beatsCount > 0 && (
          <div className="mt-2 flex items-center gap-1.5">
            <div className="flex -space-x-1">
              {routeData.storyBeats.slice(0, 3).map((beat: StoryBeat, i: number) => (
                <div
                  key={i}
        ...
        {beatsCount > 0 && (
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              {routeData.storyBeats.slice(0, 4).map((beat: StoryBeat, i: number) => (
                <span
                  key={i}
