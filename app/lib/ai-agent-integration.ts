    ...
    return {
      ...
      metadata: {
        ...
        instructor: {
          ...
          bio: `Autonomous AI instructor with ${this.config.personality} personality`,
          avatar: `https://api.dicebear.com/7.x/bottts/svg?seed=${this.config.name}`,
          isAI: true,
        },
        difficulty: "moderate",
        duration: 45,
        tags: ["ai-coached", "high-intensity", "dynamic-pricing"],
      },
