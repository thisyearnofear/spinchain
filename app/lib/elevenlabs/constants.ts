...
// API Configuration
// All requests proxy through server-side API routes for security
export const ELEVENLABS_CONFIG = {
  ttsRoute: '/api/ai/elevenlabs/tts',
  sfxRoute: '/api/ai/elevenlabs/sfx',
  sttRoute: '/api/ai/elevenlabs/stt',
  voicesRoute: '/api/ai/elevenlabs/voices',
